      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Explore the different techniques astronomers use to detect planets beyond our solar system
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {discoveryMethods.map((method) => (
            <Card 
              key={method.id} 
              className="bg-gray-800 border-gray-700 hover:border-gray-500 transition-all duration-300 hover:scale-105 cursor-pointer"
            >
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-8">
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white">About Exoplanet Discovery</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-300">
                Astronomers use multiple methods to detect exoplanets, each with unique strengths 
                and limitations. These techniques have revealed thousands of planets orbiting other stars, 
                expanding our understanding of planetary systems throughout the galaxy.
              </p>
            </CardContent>
          </Card>
